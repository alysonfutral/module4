...
class League(IdentifiedObject):
    ...
    def add_team(self, team):
        # check if team has the same 'oid' as team being added
        for the_team in self._teams:
            if the_team.oid == team.oid:
    ...
    def remove_team(self, team):
        # ensures that the team being removed is not in any competitions.
        # If the team is in a competition, throw ValueError.
        # https://docs.python.org/3/tutorial/errors.html
        for competition in self._competitions:
            if team in competition:
                raise ValueError() # throw/raise (same thing)
    ...
    def add_competition(self, competition):
        # verifies that all of the teams in the competition are part of the league.
        # Throw ValueError (a build-in exception class)
